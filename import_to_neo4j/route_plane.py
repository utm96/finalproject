...
# print(x)
routes = list(db['plane_detail'].find({}))
...
query_plane_route = ["MATCH (a:Airport {code:'","","'}),(b:Airport {code:'","","'}) CREATE (a)-[r:route { min_price:","",", max_price :","",", ave_price :" ,"", ",min_time:","",", time : ","",", ave_time : ","",", type : 'plane'}]->(b)"]
...
with driver.session() as graphDB_Session:
    for route in routes:
        ...
        query_plane_route[1] = route['departure']
        query_plane_route[3] = route['arrival']
        query_plane_route[5] = str(route['min_price'])
        query_plane_route[7] = str(route['max_price'])
        query_plane_route[9] = str(route['average_price'])
        query_plane_route[11] = str(route['time'])
        query_plane_route[13] = str(route['time'])
        query_plane_route[15] = str(route['time'])
        # query_plane_route[3] = route['arrival']
