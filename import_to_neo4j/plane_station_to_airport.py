...
with driver.session() as graphDB_Session:
    for region in listRegion1:
        for key,value in region['cost_plane'].items():
        ...
        # query_plane[3] = region['Ten tinh,thanh pho']
            ...
            query_plane_route[1] = region['Ten tinh,thanh pho']
            query_plane_route[3] = key
            query_plane_route[5] = str(value)
            query_plane_route[7] = str(value)
            query_plane_route[9] = str(value)
            query_plane_route[11] = str(region['time_plane'][key])
            query_plane_route[13] = str(region['time_plane'][key])
            query_plane_route[15] = str(region['time_plane'][key])

            query_plane_route1[1] = region['Ten tinh,thanh pho']
            query_plane_route1[3] = key
            query_plane_route1[5] = str(value)
            query_plane_route1[7] = str(value)
            query_plane_route1[9] = str(value)
            query_plane_route1[11] = str(region['time_plane'][key])
            query_plane_route1[13] = str(region['time_plane'][key])
            query_plane_route1[15] = str(region['time_plane'][key])
